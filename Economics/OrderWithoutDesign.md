...
*The Final Evaluation of Hanoi's Master Plan* (page 139)
It is impossible to design the future expansion of a city without taking into account the impact of the labor and land markets on the future distribution of the population. Land prices, rents, and commuting times are not mentioned even once in the master plan's nearly thousand pages of text, maps, and tables. It is a rather typical document that exposes the hubris of planners who think that a city needs only to be designed by a clever engineer, without taking into account market mechanisms that are constantly at play. Trying to obstruct markets always has grave consequences.
